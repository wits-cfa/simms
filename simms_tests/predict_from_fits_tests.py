...
class TestPredictFits():    
    def test_fits_predict_stokes_I(self, params):
        ...
        predict =  skymodel_from_fits(test_filename, params.ra0, params.dec0, params.freqs,
                                params.freqs[1]-params.freqs[0], params.ncorr, 'linear')
        
        # predict visibilities
        vis = im_to_vis(predict.image, params.uvw, predict.lm, params.freqs,
    ...
    def test_fits_predict_stokes_I_with_spectral_axis(self, params):
        ...
        wcs.wcs.cdelt = np.array([-params.cell_size/3600, params.cell_size/3600, params.freqs[1]-params.freqs[0]]) # pixel scale in deg
        wcs.wcs.crpix = [params.img_size/2, params.img_size/2, 1] # reference pixel
        wcs.wcs.crval = [np.rad2deg(params.ra0), np.rad2deg(params.dec0), params.freqs[0]] # reference pixel RA and Dec in deg
    ...
    def test_fits_predicting_all_stokes_linear_basis(self, params):
        ...
        predict = skymodel_from_fits(test_skymodels, params.ra0, params.dec0, params.freqs,
                                params.freqs[1]-params.freqs[0], params.ncorr, basis='linear')
    ...
    def test_fits_predicting_all_stokes_circular_basis(self, params):
        ...
        # process the FITS files
        predict = skymodel_from_fits(test_skymodels, params.ra0, params.dec0, params.freqs,
                                params.freqs[1]-params.freqs[0], params.ncorr, basis='circular')
